...
def maxmargin_loss(pos, neg, size, margin=0.3, tie=False):
	margin = 0.3 #change margin here
...
def compute_pronoun_maxmargin_loss(lprobs, target, margin):
    ...
    pronoun_pos_dist = lprobs[found_pronoun_indices[:-1]] 
...
@register_criterion('label_smoothed_cross_entropy_pronoun_maxmargin_loss')
class LabelSmoothedCrossEntropyPronounPairwiseCriterion(FairseqCriterion):
    ...
    def compute_loss(self, model, net_output, sample, reduce=True): 
        ...
        maxmargin_loss = compute_pronoun_maxmargin_loss(preserved_lprobs, preserved_target)
